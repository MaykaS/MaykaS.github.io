...
<figure>
  <img
    src="/images/blog/tab-management-friction-by-load.png"
    alt="Line chart comparing modeled friction per tab switch across 10, 50, and 100 open tabs for a naive 30-minute idle baseline versus Tab Agent."
  />
  <figcaption>
    Scenario-grounded replay benchmark with calibrated reload costs. Modeled, not wall-clock.
  </figcaption>
</figure>
...
<figure>
  <img
    src="/images/blog/tab-management-cold-reactivation-rate.png"
    alt="Line chart comparing cold reactivation event rates across memory loads for a naive baseline and Tab Agent."
  />
  <figcaption>
    The gap is event-rate, not reload speed: Tab Agent doesn't make Chrome faster, it puts you in fewer bad moments.
  </figcaption>
</figure>
...
Code: [github.com/MaykaS/tab_agent](https://github.com/MaykaS/tab_agent). Web: [tab-agent-web.vercel.app](https://tab-agent-web.vercel.app).
